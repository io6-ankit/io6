...
console.log("print", swiggyResponse.data);
console.log("line no.10", swiggyResponse.data.cards[0].card.card.text);
// console.log(
//   "line no.89",
//   swiggyResponse.data.cards[2].availability[0].nextCloseTime
// );
console.log(
  "line-no.3475",
...
console.log("line-no.3544=", swiggyResponse.data.firstOffsetRequest);
console.log(
  "line no.3333=",
...
console.log(
  "line-no.840",
  swiggyResponse.data.cards[4].groupedCard.cardGroupMap.REGULAR.cards[1].card
    .card.itemCards[5].card.info.ratings
);
console.log(
  "line-no.899",
